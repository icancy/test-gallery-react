  ...
  */
  ...
  render() {
    ...
    for (let [index, value] of imageDatas.entries()) {
      ...
      imgFigures.push(<ImgFigure key={'imgFigure' + index} data={value} ref={(ImgFigure) => {this['imgFigure' + index] = ImgFigure}} arrange={this.state.imgsArrangeArr[index]} inverse={this.inverse(index)} center={this.center(index)}/>);
